...
TZ = "Asia/Tbilisi"
CRON_TASKS = [
    ("Online ordering: check custom domains", "ordering.check_domains", "15", "*", "Re-verify custom domain DNS every hour."),
]
INTERVAL_TASKS = [
    ("Online ordering: refresh courier deliveries", "ordering.refresh_deliveries", 120, "Poll Wolt Drive / Glovo for in-flight deliveries without webhooks."),
]
...
class Migration(migrations.Migration):
    dependencies = [("ordering", "0001_initial"), ("django_celery_beat", "0019_alter_periodictasks_options")]
