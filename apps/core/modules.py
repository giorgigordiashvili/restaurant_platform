...
MODULES: tuple[Module, ...] = (
    ...
    Module(
        "gift_cards",
        _("Gift cards"),
        _("Sell physical and digital gift cards, redeem them at the till or at online checkout; liability report."),
        "card_giftcard",
        "gift_cards_enabled",
        requires=("cash",),
        recommends=("notifications",),
        app_labels=("giftcards",),
        model_names=(("giftcards", "giftcard"), ("giftcards", "giftcardbatchpage")),
        resources=("cash",),
    ),
    Module(
        "house_accounts",
        _("House accounts"),
        _("Regulars and companies on credit: charge bills to an account, settle later, monthly statements."),
        "account_balance_wallet",
        "house_accounts_enabled",
        requires=("cash",),
        recommends=("crm", "notifications"),
        app_labels=("houseaccounts",),
        model_names=(("houseaccounts", "houseaccount"), ("houseaccounts", "houseaccountstatement")),
        resources=("cash",),
    ),
    Module(
        "waitlist",
