...
def menu_category_image_path(instance, filename):
    ...
    return get_upload_path(
        instance, filename,
        f'restaurants/{instance.restaurant.slug}/menu/categories'
    )
...
def menu_item_image_path(instance, filename):
    ...
    return get_upload_path(
        instance, filename,
        f'restaurants/{instance.restaurant.slug}/menu/items'
    )
...
def qr_code_path(instance, filename):
    ...
    return get_upload_path(
        instance, filename,
        f'restaurants/{instance.table.restaurant.slug}/qrcodes'
    )
