...
class ReservationAdmin(admin.ModelAdmin):
    ...
    actions = ["confirm_reservations", "cancel_reservations", "mark_as_no_show"]
...
class ReservationBlockedTimeAdmin(admin.ModelAdmin):
    """Admin for blocked times."""
    ...
    list_filter = ["reason", "is_recurring", "restaurant"]
