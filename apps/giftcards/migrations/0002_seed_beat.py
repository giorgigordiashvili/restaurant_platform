...
TZ = "Asia/Tbilisi"
CRON_TASKS = [("Gift cards: expire", "giftcards.expire", "10", "4", "Mark gift cards past their expiry date.")]
...
class Migration(migrations.Migration):
    dependencies = [("giftcards", "0001_initial"), ("django_celery_beat", "0019_alter_periodictasks_options")]
